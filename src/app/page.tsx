      ...
      <header className="fixed top-0 z-50 w-full px-4 sm:px-6 lg:px-8 py-3">
        <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between liquid-glass-pill rounded-2xl">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="hidden sm:inline text-muted/50 text-xs font-mono select-none">{"//"}</span>
            <span className="hidden sm:inline font-mono text-[11px] text-muted tracking-wider uppercase">
              INSTITUTIONAL LEARNING SUITE
            </span>
          </div>

          <div className="flex items-center gap-6">
            <nav className="hidden md:flex items-center gap-8 font-mono text-[11px] tracking-wider text-muted">
              <a href="#methodology" className="hover:text-foreground transition-colors">METHODOLOGY</a>
              <a href="#curriculum" className="hover:text-foreground transition-colors">10 TRACKS</a>
              <a href="#diagnostics" className="hover:text-foreground transition-colors">DIAGNOSTIC LAB</a>
            </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 font-mono text-xs">
            ...
            <div className="p-8 rounded-2xl liquid-glass-card transition-all flex flex-col justify-between space-y-8">
              <div className="space-y-4">
                <div className="flex items-center justify-between text-accent font-bold text-xs pb-3 border-b border-divider">
                  <span>PILLAR I</span>
                  <span className="text-muted font-normal">CONCEPT RESOLUTION</span>
                </div>
                <h3 className="text-lg font-bold text-foreground font-sans">
                  Step-by-Step Diagnostic Engine
                </h3>
                <p className="text-xs text-muted-strong font-sans leading-relaxed">
            ...
            <div className="p-8 rounded-2xl liquid-glass-card transition-all flex flex-col justify-between space-y-8">
              <div className="space-y-4">
                <div className="flex items-center justify-between text-accent font-bold text-xs pb-3 border-b border-divider">
                  <span>PILLAR II</span>
                  <span className="text-muted font-normal">HARDWARE FLUENCY</span>
                </div>
                <h3 className="text-lg font-bold text-foreground font-sans">
            ...
            <div className="p-8 rounded-2xl liquid-glass-card transition-all flex flex-col justify-between space-y-8">
              <div className="space-y-4">
                <div className="flex items-center justify-between text-accent font-bold text-xs pb-3 border-b border-divider">
                  ...
                  <span className="text-muted font-normal">PERMANENT RECALL</span>
                </div>
                <h3 className="text-lg font-bold text-foreground font-sans">
              ...
              <div className="p-4 rounded-xl bg-white/[0.03] space-y-2 text-[11px]">
                ...
                <div className="flex items-center justify-between text-muted pt-1 border-t border-divider">
                  <span>Day 1</span>
                  <span>&rarr;</span>
                  <span>Day 3</span>
                  <span>&rarr;</span>
                  ...
                  <span>Day 14</span>
                  <span>&rarr;</span>
                  <span className="text-accent font-bold">Day 30</span>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto px-6 space-y-10">
          ...
          <div className="p-6 sm:p-8 rounded-2xl liquid-glass-card space-y-6">
            ...
            <div className="flex items-center justify-between font-mono text-xs">
              ...
              <span className="text-muted font-mono">CALCULATION DERIVATION</span>
            </div>

            <div className="text-sm sm:text-base text-foreground leading-relaxed font-sans font-medium">
            ...
            {isTeaserSubmitted && (
              <div className="p-6 rounded-xl bg-white/[0.03] space-y-4 animate-in fade-in duration-200">
                ...
                <p className="text-xs sm:text-sm text-muted-strong leading-relaxed font-sans">
            ...
            <div className="text-center pt-2">
              <Link
                href="/app"
                className="inline-flex items-center gap-2 text-xs font-mono text-accent hover:underline font-bold"
              >
      ...
      <section id="curriculum" className="py-24 relative z-10">
        <div className="max-w-7xl mx-auto px-6 space-y-12">
          ...
          <div className="max-w-3xl space-y-3">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-foreground">
              All 10 CFA Level I Curriculum Tracks
            </h2>
                ...
                {CFA_CURRICULUM.map((topic, idx) => {
                  ...
                  return (
                    <tr key={topic.id} className="hover:bg-white/[0.03] transition-colors">
                      ...
                      <td className="py-4 px-5 font-sans font-bold text-foreground text-sm whitespace-nowrap">
                        {topic.name}
                      </td>
                      ...
                      <td className="py-4 px-5 font-sans text-muted text-xs leading-relaxed">
