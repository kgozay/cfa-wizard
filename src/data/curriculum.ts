...
export const CFA_CURRICULUM: CFATopic[] = [
  {
    ...
    formulas: [
      ...
      },
      {
        ...
        calculatorKeystrokes: "[P(B|A)] [\\times] [P(A)] [\\div] [P(B)] [=]"
      },
      {
        id: "quant-t-stat",
        ...
        calculatorKeystrokes: "[DATA] -> Input X values -> [STAT] -> Read \\bar{x}, s -> Subtract \\mu_0 -> Divide by (s / \\sqrt{n})"
      }
    ]
  },
  {
    ...
    formulas: [
      {
        ...
        calculatorKeystrokes: "[Bid_{A/B}] [\\times] [Bid_{B/C}] [=]"
      },
      {
        ...
        calculatorKeystrokes: "1 [-] [MPC] [\\times] (1 [-] [t]) [=] [1/x]"
      }
    ]
  },
  {
    ...
    formulas: [
      ...
      },
      {
        ...
        calculatorKeystrokes: "[CF] -> [2nd][CLR WORK] -> CF0 = -CF_0 [ENTER] -> C01 = CF_1 [ENTER] -> [NPV] -> I = r [ENTER] -> [↓] -> [CPT]"
      }
    ]
  },
  {
    ...
    formulas: [
      {
        ...
        calculatorKeystrokes: "[COGS_{LIFO}] [-] [\\Delta LIFO\\ Reserve] [=]"
      },
      {
        id: "fsa-dupont-5",
        ...
        calculatorKeystrokes: "[Tax\\ Burden] [\\times] [Interest\\ Burden] [\\times] [EBIT\\ Margin] [\\times] [Asset\\ Turnover] [\\times] [Leverage] [=]"
      }
    ]
  },
  {
    ...
    formulas: [
      ...
      },
      {
        ...
        calculatorKeystrokes: "[P_0] [\\times] (1 [-] [IM]) [\\div] (1 [-] [MM]) [=]"
      }
    ]
  },
  {
    ...
    formulas: [
      ...
      },
      {
        ...
        calculatorKeystrokes: "[-] [ModDur] [\\times] [\\Delta y] [+] (0.5 [\\times] [Convexity] [\\times] [\\Delta y]^2) [=]"
      }
    ]
  },
  {
    ...
    formulas: [
      {
        ...
        calculatorKeystrokes: "[c_0] [+] [X] [\\div] (1 [+] [r])^T [-] [S_0] [=] [p_0]"
      },
      {
        ...
        calculatorKeystrokes: "[S_0] [\\times] (1 [+] [r])^T [=]"
      }
    ]
  },
  {
    ...
    formulas: [
      {
        ...
        calculatorKeystrokes: "[NOI] [\\div] [Cap\\ Rate] [=]",
        variables: [
      ...
      },
      {
        ...
        calculatorKeystrokes: "([End\\ AUM] [-] [Mgmt\\ Fee] [-] [HWM]) [\\times] 0.20 [=]"
      }
    ]
  },
  {
    ...
    formulas: [
      {
        ...
        calculatorKeystrokes: "[R_f] [+] [\\beta] [\\times] ([R_m] [-] [R_f]) [=]",
        variables: [
      ...
      },
      {
        ...
        calculatorKeystrokes: "([R_p] [-] [R_f]) [\\div] [\\sigma_p] [=]"
      }
    ]
  },
  {
